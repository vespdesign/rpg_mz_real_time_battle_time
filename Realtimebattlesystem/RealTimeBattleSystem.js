 ...
 * VERSION DE PRUEBA ALPHA 0.11
 */

(function() {
    // Constantes para la configuración del sistema
    const DISTANCIA_DE_ATAQUE = 1;   // Distancia para iniciar el ataque
    const DISTANCIA_DE_PERSECUCION = 50;  // Distancia para que el enemigo persiga al jugador
    ...
    Game_Event.prototype.perseguirJugador = function() {
        // Implementación básica de la lógica para mover el enemigo hacia el jugador
